...
class PostgreChatMemoryMessage:
    _instances = {}

    @classmethod
    def get_instance(cls, session_id: str) -> 'PostgreChatMemoryMessage':
        """Get or create a PostgreChatMemoryMessage instance for a given session ID.

        Args:
            session_id (str): Unique identifier for the chat session (e.g., Slack channel ID)

        Returns:
            PostgreChatMemoryMessage: Instance of the memory manager for the session
        """
    ...
    def __init__(self, session_id: str) -> None:
        """Initialize a new PostgreChatMemoryMessage instance.
